...
class Router_Com_Hw(pp:(String,Any)) extends Module
  with Has_IO
  with Reconfigurable {
  ...
  val all_MUXes : Array[MUX] = new Array[MUX](IO_LookUpTable.length);var mux_c = 0
...
class MUX extends Reconfigurable{
