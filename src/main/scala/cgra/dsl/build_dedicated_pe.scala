...
object build_dedicated_pe extends Build {
  ...
  dedi_pe have ("subnet-specific-inst",Map(2 -> signed_insts_list, 4 -> unsigned_insts_list))

  // Add Ports and assign decomposer
  val num_input = 6; val num_output = 2;dedi_pe have("num_output",num_output);dedi_pe have("num_input",num_input)
