source -echo -verbose ./dc_script/common_setup.tcl
source -echo -verbose ./dc_script/dc_setup_filenames.tcl
...
#################################################################################
set LIBRARY_DONT_USE_PRE_COMPILE_LIST  "./dc_script/snpsll_hpdu_synth.tcl";# Tcl file for Synopsys Logic Library don't use list before first compile          
}
#################################################################################
