...
def parse_dir_name(rep_dir):
    config = {}
    DesignInFile = rep_dir.split(".v_")[0]
    DC_Config = rep_dir.split(".v_")[1]
    args = DC_Config.split("_")
    config["DesignInFile"]   = DesignInFile
    config["mainFeature"]    = args[0]
    config["targetLibrary"]  = args[1]
