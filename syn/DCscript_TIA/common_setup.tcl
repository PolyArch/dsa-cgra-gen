...
set DESIGN_NAME                   "processing_element"  ;#  The name of the top-level design
set DESIGN_Feature ""

set Period 1  ;# ns 1/Period = frequency (GHz)

set Researcher "Jian_5by5"
...
set RTL_SOURCE_FILES  [eval [list exec ls ] [glob $RTL_SOURCE_DIR/${Researcher}/TIA/*.sv ]]
