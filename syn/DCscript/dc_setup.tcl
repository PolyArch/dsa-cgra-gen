source -echo -verbose ./DCscript/common_setup.tcl
source -echo -verbose ./DCscript/dc_setup_filenames.tcl
...
#################################################################################
set LIBRARY_DONT_USE_PRE_COMPILE_LIST  "./DCscript/snpsll_hpdu_synth.tcl";# Tcl file for Synopsys Logic Library don't use list before first compile          
}
#################################################################################
